...
import { getUsers, updateUser, deleteUser, AdminUser } from '../../services/api';
...
export function UserList() {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '900px', margin: '0 auto' }}>
      <h2 style={{ color: '#e2e8f0', marginBottom: '1.5rem', fontSize: '1.5rem', fontWeight: 700 }}>User Management</h2>
